...
class SettingStorageData extends Equatable {
  ...
  factory SettingStorageData.fromJson(Map<String, dynamic> json) {
    ...
    return SettingStorageData(
      textScaleType: _find(
          TextScaleType.values, json['textScaleType'] as String?, TextScaleType.standard),
      folderPath: json['folderPath'] as String?,
      orientationType: _find(
          OrientationType.values, json['orientationType'] as String?, OrientationType.auto),
      trackIntervalType: _find(
          TrackIntervalType.values, json['trackIntervalType'] as String?, TrackIntervalType.sec10),
      trackDisplayDaysType: _find(
          TrackDisplayDaysType.values, json['trackDisplayDaysType'] as String?, TrackDisplayDaysType.week1),
      trackRetentionDaysType: _find(
          TrackRetentionDaysType.values, json['trackRetentionDaysType'] as String?, TrackRetentionDaysType.month1),
    );
  }
